...
namespace Authorization.IdentityServer.Account
{
    ...
    public class ExternalController : Controller
    {
        ...
        public async Task<IActionResult> Callback()
        {
            ...
            additionalLocalClaims.Add(new Claim(JwtClaimTypes.EmailVerified, user.EmailConfirmed.ToString()));
        ...
        private async Task<IdentityUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
            ...
            var emailVerified = claims.FirstOrDefault(x => x.Type == JwtClaimTypes.EmailVerified)?.Value;


            if (emailVerified != null)
            {
                filtered.Add(new Claim(JwtClaimTypes.EmailVerified, emailVerified));
            }
